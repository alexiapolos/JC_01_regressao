...
**Objetivo**: Avaliar o impacto das variáveis peso do carro (`wt)`, potência( `hp)` e número de cilindros ( `cyl`) na eficiência de combustível (`mpg`).
...
grid_data$cyl <- factor("4", levels = levels(train_data$cyl))  
